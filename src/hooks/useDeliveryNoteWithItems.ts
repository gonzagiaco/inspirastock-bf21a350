    ...
    queryFn: async () => {
      ...
      if (!isOnline) {
        ...
        const note: DeliveryNote = {
          ...
          globalAdjustmentPct: Number(noteData.global_adjustment_pct ?? 0),
      ...
      try {
        await localDB.delivery_notes.put({
          ...
          status: data.status,
          global_adjustment_pct: data.global_adjustment_pct ?? 0,
      ...
      const note: DeliveryNote = {
        ...
        globalAdjustmentPct: Number(data.global_adjustment_pct ?? 0),
